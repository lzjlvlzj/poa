...
<!--显示表单内容-->
<div id=MainArea>
   <s:form action="user_%{ userId == null ? 'add' : 'edit' }">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table  class="mainForm">
                    <tr><td width="">所属部门</td>
                        <td>
                        	<s:select headerKey="" headerValue="--请选择部门--" name="deptId"
								list="#deptList" listKey="deptId" listValue="deptName" cssClass="SelectStyle"></s:select>
                        </td>
                    </tr>
                    <tr><td>登录名</td>
                    ...
                    <tr><td>姓名</td>
                        <td><s:textfield  type="text" name="userName" cssClass="InputStyle"/> *</td>
                    </tr>
                    <tr><td>性别</td>
                        <td>
                        	<s:radio name="status" list="%{#{'0':'激活','1':'锁定'}}"></s:radio>
						</td>
                    </tr>
					<tr><td>性别</td>
                        <td>
                        	<s:radio name="gender" list="%{#{'0':'保密','1':'男', '2':'女'}}"></s:radio>
						</td>
                    </tr>
					<tr>
						<td>联系电话</td>
                    ...
                    <tr>
                    	<td>QQ</td>
                        <td><s:textfield  type="text" name="qq" cssClass="InputStyle"/></td>
                    </tr>
                    <tr>
                    	<td>出生日期</td>
                        <td><input name="birthDay" class="InputStyle"/></td>
                    </tr>
                    <tr><td>备注</td>
                        <td><s:textarea name="description" class="TextareaStyle" cssClass="InputStyle"/></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="ItemBlock">
                <table class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td>
                        <s:select multiple="true" size="10" name="ids"
							list="#roleList" listKey="id" listValue="roleName" cssClass="SelectStyle"></s:select>
                            按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
                </table>
